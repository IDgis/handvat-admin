...
Text.attachSchema (new SimpleSchema({
	...
	appCoupling: {
		...
		allowedValues: ["popup-handleiding", "popup-help", "popup-contact", "popup-links", "popup-disclaimer", 
		                "landschapstype-algemeen", "kernkwaliteit-relief", "kernkwaliteit-cultuurhistorie", 
		                "kernkwaliteit-groenkarakter", "kernkwaliteit-openbesloten", "deelgebied-baneheide", 
		                "deelgebied-bekken-heerlen", "deelgebied-doenrade", "deelgebied-eperheide", "deelgebied-geleenbeek", 
		                "deelgebied-geuldal", "deelgebied-maasdal", "deelgebied-maasterras-gronsveld", "deelgebied-margraten", 
